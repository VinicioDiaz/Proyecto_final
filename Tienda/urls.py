...
from Tienda.views import pagina_inicio, comprar_producto, modificar_producto, ProductosListView, ProductosCreateView, \
ProductosDeleteView
...
urlpatterns = [
    ...
    path('comprar-producto/', comprar_producto),
